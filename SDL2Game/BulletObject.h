...
public:
	...
	enum BulletDir
	{
		DIR_RIGHT = 20, // 20 cho cach xa may thagn khac
		DIR_LEFT = 21,
		DIR_UP = 22,
		DIR_UP_LEFT = 23,
		DIR_UP_RIGHT = 24,
	...
	void HandleMove(const int& x_border, const int& y_border); //  xu ly dan bay ra ngoai map
...
private:
	...
	int y_val_;
	bool is_move_;
	unsigned int bullet_dir_; // direction
	unsigned int bullet_type_; // loai dan ban ra
